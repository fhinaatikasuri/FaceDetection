...
<section id="home">
    <div class="container">
        <div class="d-flex gap-5 wrap justify-content-center align-items-center">
            <div style="">
                <h1 style="font-family: 'Raleway'; font-style: normal; font-weight: 700; font-size: 56px; line-height: 66px; letter-spacing: 1.2px; text-transform: capitalize; color: #212121;">Selamat Datang di <br> Fhina Show Room</h1>
                <p class="mt-5" style="font-family: 'Raleway'; margin-bottom: 40px; font-style: normal; font-weight: 400; font-size: 20px; line-height: 20px; letter-spacing: 0.2px; color: #757575;">Menyediakan Mobil Terbaik untuk Anda</p>
            ...
            <div class="d-flex align-items-center gap-5" style="margin-top:100px;">
                    ...
                    <p style="margin-top: 20px; font-family: 'Raleway'; font-style: normal; font-weight: 500; font-size: 12px; line-height: 14px; text-align: center; letter-spacing: 0.46px; color: #757575;">Fhina_1202202075</p>
                </div>
            </div>
