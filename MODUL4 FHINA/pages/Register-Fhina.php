            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="form-login m-auto ps-5">
                        <h2 class="fw-bold mb-4">Register User|Fhina_1202202075</h2>
                        <form action="login-Fhina.php" method="post">
                            <div class="mb-1">
                        ...
                        <p>Apakah sudah memiliki akun? <a href="login-Fhina.php">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
