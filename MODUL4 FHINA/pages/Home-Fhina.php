        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link text-white" aria-current="page" href="login-Fhina.php">Login</a>
                    </li>
                </ul>
            </div>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
    ...
    <section id="jumbotron">
        <div class="container">
            <div class="d-flex justify-content-center align-items-center tengah gap-5">
                <div>
                    <h1>
                        Selamat Datang di<br /> Show Room Fhina
                    </h1>
                    <p>Showroom kami memberikan experience terbaik<br /> dan Mobil terbaik bagi anda.</p>
                    ...
                    <span class="d-flex gap-5 align-items-center">
                        ...
                        <p style="margin-top: 80px; font-size:12px;">Fhina_1202202075</p>
                    </span>
                </div>
