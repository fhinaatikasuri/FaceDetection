...
$list = query("SELECT * FROM showroom_fhina_table WHERE id_mobil = $id")[0];
...
<head>
    ...
    <title>Detail Mobil | Fhina_1202202075 Showroom</title>
        ...
        <div class="isian d-flex justify-content-center mt-5">
            ...
            <div class="col">
                <div class="row">
                    ...
                    <a href="Edit-Fhina.php?id=<?= $list["id_mobil"]; ?>"><button
