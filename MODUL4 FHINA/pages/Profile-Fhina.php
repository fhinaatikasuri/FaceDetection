...
$dataProf = mysqli_query($connect, "SELECT * FROM user WHERE email = '$email'"); 
...
if(isset($_POST["update"])) {
    ...
    // kalau user ingin mengubah password, berarti langsung mengeksekusi pada bagian else
        ...
        $konfirmasi_password = mysqli_real_escape_string($connect, $_POST["cPassword"]);
...
<head>
    ...
    <title>Profile User | Fhina_1202202075</title>
        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav gap-4">
                    <li class="nav-item">
                        <a class="nav-link text-white" aria-current="page" href="Home-Fhina.php">Home</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link text-white" aria-current="page" href="Add-Fhina.php"><button
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="Profile-Fhina.php">Profile</a></li>
    ...
    <footer class="text-center" style="margin:0 0 0 150px;">
        <div class="bungkus">
            <div class="logo_nim d-flex">
                ...
                <p class="d-inline">Fhina_1202202075</p>
            </div>
        </div>
    </footer>
