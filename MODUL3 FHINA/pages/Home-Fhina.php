...
<body>
  ...
  <section id="home">
    <div class="container">
      <div class="d-flex gap-5 cover justify-content-center align-items-center">
        <div>
          ...
          <a href="<?php (mysqli_num_rows($result) > 0) ? print "./pages/List-Fhina.php" : print "./pages/Add-Fhina.php" ?>" class="button btn-primary">MyCar</a>
        ...
        <img src="<?php echo "asset/images/depan.png" ?>" alt="jumbotron">
      </div>
    </div>
  </section>
